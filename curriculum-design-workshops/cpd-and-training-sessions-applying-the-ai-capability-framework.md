...
This scenario supports continuing professional development (CPD) and training sessions where staff, educators, or professionals develop new capabilities, particularly in relation to AI, digital practice, and changing professional roles.
...
The purpose of this scenario is to help facilitators use AI to support capability development, while ensuring that learning remains reflective, contextual, and grounded in human judgement.
...
- personalise prompts or feedback  
- summarise key concepts or discussions  

These uses matter because:

- generated examples may lack contextual relevance  
- personalised feedback can mask assumptions  
...
- where struggle and uncertainty are productive  

Key awareness questions:

- What capability are we actually developing?  
...
CPD and training shape professional norms.
...
Following CPD sessions, consider:
